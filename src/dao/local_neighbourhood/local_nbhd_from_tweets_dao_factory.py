...
from src.dao.local_neighbourhood.setter.mongo_local_nbhd_from_tweets_setter import MongoLocalNeighbourhoodSetter
from src.dao.local_neighbourhood.getter.local_neighbourhood_getter import LocalNeighbourhoodGetter
from src.dao.local_neighbourhood.getter.mongo_local_nbhd_from_tweets_getter import MongoLocalNbhdFromTweetsGetter
from src.shared.mongo import get_collection_from_config
from typing import Dict


class LocalNbhdFromTweetsDAOFactory():
    def create_getter(config: Dict) -> LocalNeighbourhoodGetter:
        local_neighbourhood_getter = None
        if config["type"] == "Mongo":
            local_neighbourhood_getter = MongoLocalNbhdFromTweetsGetter()
