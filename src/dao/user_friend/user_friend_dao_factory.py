...
from src.dao.user_friend.setter.mongo_friend_setter import MongoFriendSetter
from src.dao.user_friend.getter.friend_getter import FriendGetter
from src.dao.user_friend.getter.mongo_friend_getter import MongoFriendGetter
from src.shared.mongo import get_collection_from_config
from typing import Dict

class UserFriendDAOFactory():
