...
class FriendsCleaner1():
    ...
    def clean_friends(self, user_id, tweet_threshold=200, follower_threshold=100, bot_threshold=0.5, percent_threshold=40):
    ...
    def clean_friends_from_list(self, user_id, friends_list, tweet_threshold=200, follower_threshold=100, bot_threshold=0.5, percent_threshold=40):
        clean_friends_list = []
        clean_users = []
        ...
        while len(clean_users) > target_num:
            curr_tweet_thresh += 200    # can probably alter these numbers
